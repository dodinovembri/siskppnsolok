...
<table id="atas">
	<tr>
	<td id="no">
		Nomor <span style="margin-left: 0.9cm">:</span> S-<?php echo $no_surat; ?>/WPB.03/KP.090/<?php echo $this->session->userdata('tahun_anggaran'); ?>	
	</td>
	<td id="tgl">
...
<br>
<p id="badan1">
<span style="margin-left: 0cm"></span>Yth. <?php echo $satker; echo " "; echo $kepada; echo " ("; echo $kode; echo ")" ?><br>
...
<table id="badan">
	<tr>
		<td valign="top">1.</td>
		<td>Terdapat dana SP2D <?php echo $satker; echo " ("; echo $kode; echo ") "; ?> yang diretur oleh <?php echo $bank_retur; ?> penerima atas data SP2D sesuai Daftar Retur terlampir;</td>
	</tr>
	<tr>
		<td valign="top">2.</td>
		<td>
	...
	<tr>
		<td valign="top">3.</td>
		<td>
			Penyampaian Surat Ralat/Perbaikan Rekening berikut lampiran sebagaimana dimaksud pada angka 3 agar dilakukan paling lambat tanggal 7(tujuh) hari kerja setelah tanggal surat ini yaitu tanggal <?php echo tanggal_indo($tanggal_ralat); ?>.
		</td>
	</tr>
	<tr>
		<td valign="top">4.</td>
