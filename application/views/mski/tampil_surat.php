...
<?php echo $kepada;?> (<?php echo $kode; ?>)<br>
di <?php echo $tempat; ?>
<br></p>
<table id="badan">
	<tr>
		...
		<table id="badan2">
			...
			<tr>
				<td valign="top">b.</td>
				<td>
					Surat Permohonan Persetujuan (TUP) dari Kuasa Pengguna Kuasa Anggaran nomor <?php echo $no_surat_pengajuan; ?> tanggal <?php echo tanggal_indo($tanggal_pengajuan); ?> tentang Tambahan Uang Persediaan.
				</td>
			</tr>
		</table>
		</td>
	...
	<tr>
		<td valign="top">2.</td>
		<td>
			Sehubungan dengan butir 1 tersebut diatas, dengan ini di berikan persetujuan Tambahan Uang Persediaan sebesar <?php echo $jumlah_uang; ?>,- ( <?php echo terbilang($jumlah_uang );?> rupiah ) untuk keperluan medesak Satuan Kerja <?php echo $kepada; ?> kode <?php echo $kode; ?> atas beban DIPA TA 2018 nomor <?php echo $no_beban; ?> Tanggal <?php echo tanggal_indo($tanggal_ketetapan_beban); ?>.
		</td>
	</tr>
	<tr>
		<td valign="top">3.</td>
...
Demikian untuk menjadi perhatian.</p>
	...
	<?php echo $status_kepala; echo " "; echo $ket_jabatan_kepala; ?><br><br><br><br>
