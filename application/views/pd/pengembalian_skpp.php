...
<fieldset>
<legend id="head">Input Surat Pengembalian SKPP</legend>
<form id="form" action="<?php echo base_url('index.php/c_pd/simpan_pengembalian_skpp') ?>" method="post">
	...
	<input id="kolom" type="text" name="lampiran" required><br><br>

	<label>Pengembalian Atas Nama</label> <span style="margin-left: 3.8em;">:</span> 
	<input id="kolom" type="text" name="pengembalian_atas_nama" required><br><br>
