<?php 
foreach ($pengembalian_skpp as $hasil) { ?>
...
<tr>
	<td id="no">		
		Lampiran : <?php echo $hasil->lampiran; ?> Berkas<br>
	</td>
</tr>
<tr>
	<td id="no">
		Perihal <span style="margin-left: 0.42cm">:</span> Pengembalian Surat Keterangan Penghentian Pembayaran  (SKPP)<br><span style="margin-left: 2cm"></span> a.n <?php echo $hasil->pengembalian_atas_nama; ?>
	</td>
</tr>
</table>
<br>
<p id="badan">
Yth. KPA <?php echo $hasil->kepada; ?><br>
Di <?php echo $hasil->tempat; ?> 
<br><br>
<span style="margin-left: 1cm"></span>Sehubungan dengan Surat Keterangan Penghentian Pembayaran (SKPP) a.n <?php echo $hasil->pengembalian_atas_nama; ?> Nomor <?php echo $hasil->no_surat_pengajuan; ?> tanggal <?php echo tanggal_indo($hasil->tanggal_pengajuan); ?>, dengan ini kami kembalikan SKPP dimaksud dikarenakan <?php echo $hasil->alasan; ?><br><br>
