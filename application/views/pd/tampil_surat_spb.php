...
<table id="atas">
	<tr>
	<td id="no">
		Nomor <span style="margin-left: 0.4cm">:</span> S-<?php echo $no_surat; ?>/WPB.03/KP.090/<?php echo $this->session->userdata('tahun_anggaran'); ?>
	</td>
	<td id="tgl">
...
di <?php echo $tempat; ?>
<br><br>
<span style="margin-left: 1cm"></span>Berikut ini kami sampaikan bahwa SPM saudara dengan Nomor <?php echo $no_surat_pengajuan; ?> tanggal <?php echo tanggal_indo($tanggal_pengajuan); ?> tidak dapat di proses dikarenakan <?php echo $alasan; ?>. Oleh karena itu, diharapkan melakukan perbaikan SPM untuk dapat diajukan kembali ke KPPN Solok.<br>
Bersama ini juga kami sampaikan bahwa <b><?php echo $pesan; ?>.</b><br><br>
