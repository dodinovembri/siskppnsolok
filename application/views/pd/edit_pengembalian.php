<?php foreach ($pengembalian_skpp as $p) { ?>
...
$(document).ready(function(){
 ...
 $('#nama_kepala').change(function(){    // KETIKA ISI DARI FIEL 'NPM' BERUBAH MAKA ......
  ...
  $.ajax({        // Memulai ajax
    url: "<?php echo base_url('index.php/c_pd/nama_kepala_skpp') ?>",    // file PHP yang akan merespon ajax
    method: "POST",      
...
<fieldset>
<legend id="head">Edit Surat Pengembalian SKPP</legend>
<form id="form" action="<?php echo base_url('index.php/c_pd/simpan_edit_pengembalian_skpp') ?>" method="post">
	<label>No Surat</label> <span style="margin-left: 11.9em;">:</span> 
	<input id="kolom" type="text" name="no_surat" value="<?php echo $p->no_surat; ?>" required><br><br>

	<label>Tanggal Surat</label> <span style="margin-left: 9.5em;">:</span> 
	<input id="kolom" type="date" name="tanggal_surat" value="<?php echo $p->tanggal_surat; ?>" required><br><br>

	<label>Lampiran</label> <span style="margin-left: 11.5em;">:</span> 
	<input id="kolom" type="text" name="lampiran" value="<?php echo $p->lampiran; ?>" required><br><br>

	<label>Pengembalian Atas Nama</label> <span style="margin-left: 3.8em;">:</span> 
	<input id="kolom" type="text" name="pengembalian_atas_nama" value="<?php echo $p->pengembalian_atas_nama; ?>" required><br><br>

	<label>Kepada</label> <span style="margin-left: 12.5em;">:</span> 
	<input id="kolom" type="text" name="kepada" value="<?php echo $p->kepada; ?>" required><br><br>

	<label>Tempat</label> <span style="margin-left: 12.6em;">:</span> 
	<input id="kolom" type="text" name="tempat" value="<?php echo $p->tempat; ?>" required><br><br>

	<label>No Surat Pengajuan</label> <span style="margin-left: 6.5em;">:</span> 
	<input id="kolom" type="text" name="no_surat_pengajuan" value="<?php echo $p->no_surat_pengajuan; ?>" required><br><br>

	<label>Tanggal Pengajuan</label> <span style="margin-left: 7em;">:</span> 
	<input id="kolom" type="date" name="tanggal_pengajuan" value="<?php echo $p->tanggal_pengajuan; ?>" required><br><br>

	<label>Alasan</label> <span style="margin-left: 12.8em;">:</span> 
	<input id="kolom" type="text" name="alasan" value="<?php echo $p->alasan; ?>" required><br><br>

	<label>Status Kepala</label> <span style="margin-left: 9.5em;">:</span> 
	...
	<span style="margin-left: 16.3em;">: </span> 
	...
	<label>Nama Kepala</label> <span style="margin-left: 9.8em;">:</span> 
	...
	<label>Nip Kepala</label> <span style="margin-left: 11em;">:</span> 
