...
<table id="atas">
	<tr>
	<td id="no">
		Nomor <span style="margin-left: 0.86cm">:</span> S-<?php echo $no_surat; ?>/WPB.03/KP.090/<?php echo $this->session->userdata('tahun_anggaran'); ?>
	</td>
	<td id="tgl">
...
<br></p>
<p id="badan">
<span style="margin-left: 1cm"></span>Berdasarkan catatan dalam pembukuan dan usulan UAKKBUN KPPN dapat dikemukakan bahwa <?php echo $kepada; ?> yang saudara pimpin belum melaksanakan rekonsiliasi/lpj sesuai dengan ketentuan yang berlaku sehinggga Kantor/Satuan Kerja saudara kami berikan sanksi <?php echo $sanksi; ?> penerbitan SP2D atas Surat Perintah Membayar (SPM) yang diajukan, kecuali SPM Belanja Pegawai, SPM LS dan SPM Pengembalian.<br><br>
